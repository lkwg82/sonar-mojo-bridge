...
public class BridgeMojoMapper<T extends ResultTransferHandler> {
  ...
  /**
   * injects the {@link de.lgohlke.sonar.maven.ResultTransferHandler} into a {@link de.lgohlke.sonar.maven.BridgeMojo}
   *
   * @throws de.lgohlke.sonar.maven.BridgeMojoMapperException
   */

...
public class Maven2SonarEmbedder {
  // private final static Logger logger = LoggerFactory.getLogger(Maven2SonarEmbedder.class);
  // private final MavenRequest mavenRequest;
  // private final MavenEmbedder embedder;
  //
  // private Maven2SonarEmbedder(final MavenEmbedder embedder, final MavenRequest mavenRequest) {
  ...
  // }
  //
  // public Maven2SonarEmbedder build() throws MavenEmbedderException {
  //
  ...
  // return new Maven2SonarEmbedder(embedder, mavenRequest);
  // }
  // }
}
